...
import { Activity, Home, Inbox, ScanLine, Wallet, type LucideIcon } from "lucide-react-native";
...
export default function WalletLayout() {
  ...
  return (
    ...
    >
      ...
      <Tabs.Screen name="payment-wallet" options={{ title: "Wallet", tabBarIcon: tabIcon(Wallet) }} />
      ...
      <Tabs.Screen name="topup-checkout" options={{ href: null }} />
